...
require_once trailingslashit( PGSCORE_PATH ) . 'includes/elementor/elementor.php';
...
function pgscore_file_inclusions() {
	...
	if ( is_admin() ) {
		...
		require_once trailingslashit( PGSCORE_PATH ) . 'includes/healper_builder-functions.php';
		require_once trailingslashit( PGSCORE_PATH ) . 'includes/admin/header_builder/header-builder-lib.php';
		require_once trailingslashit( PGSCORE_PATH ) . 'includes/admin/class-ciyashop-footer-builder.php';
		require_once trailingslashit( PGSCORE_PATH ) . 'includes/admin/footer-builder/footer-layout-helper-fields.php';
