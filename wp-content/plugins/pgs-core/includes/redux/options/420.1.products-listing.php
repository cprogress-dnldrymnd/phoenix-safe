		...
		'fields'           => array(
			...
			array(
				...
				'options'     => array(
					...
					'grocery-1'                => array(
						'alt'   => esc_html__( 'Grocery 1', 'pgs-core' ),
						'title' => esc_html__( 'Grocery 1', 'pgs-core' ),
						'img'   => esc_url( PGSCORE_URL . 'images/options/product_hover_style/grocery-1.jpg' ),
					),
					'grocery-2'                => array(
						'alt'   => esc_html__( 'Grocery 2', 'pgs-core' ),
						'title' => esc_html__( 'Grocery 2', 'pgs-core' ),
						'img'   => esc_url( PGSCORE_URL . 'images/options/product_hover_style/grocery-2.jpg' ),
					),
				),
			...
			array(
				...
				'default'  => 'square',
				'required' => array( 'product_hover_style', '=', array( 'image-center', 'image-icon-left', 'image-icon-bottom', 'image-left', 'image-bottom', 'image-bottom-2', 'info-bottom', 'grocery-1', 'grocery-2' ) ),
			),
			array(
				...
				'default'  => 'flat',
				'required' => array( 'product_hover_style', '=', array( 'image-center', 'image-icon-bottom', 'image-icon-left', 'image-left', 'image-bottom', 'grocery-1', 'grocery-2' ) ),
			),
			array(
			...
			array(
				...
				'type'     => 'button_set',
				'title'    => esc_html__( 'Button Color', 'pgs-core' ),
				'options'  => array(
					'dark'  => esc_html__( 'Dark', 'pgs-core' ),
					'light' => esc_html__( 'Light', 'pgs-core' ),
				),
				'default'  => 'light',
				'required' => array( 'product_hover_style', '=', array( 'default', 'icon-top-left', 'icons-top-right', 'image-left', 'button-standard', 'icons-left', 'icons-rounded', 'icons-bottom-right', 'hover-summary', 'minimal-hover-cart', 'minimal', 'standard-info-transparent', 'standard-quick-shop', 'image-bottom-2', 'grocery-1', 'grocery-2' ) ),
			),
			array(
