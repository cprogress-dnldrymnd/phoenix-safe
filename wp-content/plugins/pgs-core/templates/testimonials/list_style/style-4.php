...
?>
<div class="testimonial testimonial-style-4 owl-carousel owl-theme owl-carousel-options" data-owl_options="<?php echo esc_attr( $owl_options ); ?>">
					...
					<div class="client-image">
						...
						<div class="author-photo">
							...
							if ( isset( $ciyashop_options['enable_lazyload'] ) && $ciyashop_options['enable_lazyload'] && defined( 'LOADER_IMAGE' ) && ! vc_is_inline() ) {
								echo '<img class="img-responsive owl-lazy rounded-circle" src="' . esc_url( LOADER_IMAGE ) . '" data-src="' . esc_url( $testimonials_img_src ) . '" alt="' . esc_attr( $testimonials_img_alt ) . '" />';
							} else {
