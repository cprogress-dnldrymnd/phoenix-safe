					...
					<div>
						<div class="author-photo">
							...
							if ( isset( $ciyashop_options['enable_lazyload'] ) && $ciyashop_options['enable_lazyload'] && defined( 'LOADER_IMAGE' ) && ! vc_is_inline() ) {
								echo '<img class="img-responsive owl-lazy" src="' . esc_url( LOADER_IMAGE ) . '" data-src="' . esc_url( $testimonials_img_src ) . '" alt="' . esc_attr( $testimonials_img_alt ) . '" />';
							} else {
								echo '<img class="img-responsive" src="' . esc_url( $testimonials_img_src ) . '" alt="' . esc_attr( $testimonials_img_alt ) . '" />';
							}
							?>
						</div>
					</div>
