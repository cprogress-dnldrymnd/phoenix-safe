...
$this->add_render_attribute( 'pgscore_testimonial_list', 'class', 'testimonial testimonial-style-7 owl-carousel owl-theme owl-carousel-options' );
			...
			<div class="testimonial-meta">
				<div class="client-image">
					...
					<div class="author-photo">
						<?php echo '<img class="img-responsive rounded-circle" src="' . esc_url( $testimonials_img_src ) . '" alt="' . esc_attr( $testimonials_img_alt ) . '" />'; ?>
					</div>
				</div>
