...
require_once get_parent_theme_file_path( '/includes/classes/class-pgs-campaigns.php' );
...
require_once get_parent_theme_file_path( '/includes/backward-compatibility.php' );

// Ciyashop Elementor Studio
require_once get_parent_theme_file_path( '/includes/ciyashop-studio/ciyashop-studio.php' );
