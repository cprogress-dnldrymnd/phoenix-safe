...
function ciyashop_product_actions_add_variation_product_view() {
	...
	<div class="ciyashop-product-variations-wrapper ciyashop-swatches" data-id="<?php echo esc_attr( $id ); ?>">
		<?php
		if ( 'standard-quick-shop' !== $product_hover_style ) {
			?>
...
/*
 * Change the variations threshold fo ajax call
 */

function ciyashop_change_woocommerce_ajax_variation_threshold( $amount, $product ) {
    return 100; // change this to the amount of variations you want to load
}
add_filter( 'woocommerce_ajax_variation_threshold', 'ciyashop_change_woocommerce_ajax_variation_threshold', 10, 2 );