...
function ciyashop_body_classes( $classes ) {
	...
	if ( function_exists( 'WC' ) && ( is_shop() || is_product_category() || is_product_tag() ) ) {
		if ( ( wp_is_mobile() && isset( $ciyashop_options['off_canvas_mobile_shop_sidebar'] ) && $ciyashop_options['off_canvas_mobile_shop_sidebar'] ) || ( ! wp_is_mobile() && isset( $ciyashop_options['off_canvas_shop_sidebar'] ) && $ciyashop_options['off_canvas_shop_sidebar'] ) ) {
