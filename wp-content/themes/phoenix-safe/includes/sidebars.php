...
function ciyashop_sidebars_init() {
	...
	register_sidebar(
		array(
			...
			'description'   => __( 'Add widgets here to display on product shop filters sidebar. "<strong>PGS Shop Filters</strong>" widget will not work here, if you want to use it simply just switch to Filter Type Default in <strong>Theme Options > Products Filters > Filter Type</strong>', 'ciyashop' ),
